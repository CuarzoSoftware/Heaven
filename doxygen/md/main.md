<p align="left">
  ...
  <a href="https://github.com/CuarzoSoftware/Heaven">
    <img src="https://img.shields.io/badge/version-0.1.0-brightgreen" alt="Current Heaven version." />
  </a>
</p>
...
single _global menu_ application, and lets the compositor decide whose menu is
...
The compositor decides which _client_ is active. The client itself decides
which of _its own_ top bars should be displayed (e.g. the one belonging to the
