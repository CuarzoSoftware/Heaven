...
std::shared_ptr<CZ::HNClientAPI::HNAction> HNAction::Make(const std::string &title, const std::string &icon, const std::string &shortcut, bool enabled, HNObject *parent) noexcept
{
